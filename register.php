...
<html>
<head>
	<title>Welcome to INFINITO!</title>
...
<body>
	...
	<div id="background">
		...
		<img src="assets\images\title.png"style="height: 200;margin-left: 450;">
		...
		<div id="loginContainer">
			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="loginUsername" name="loginUsername" type="text" placeholder="Enter Your Username" value="<?php getInputValue('loginUsername') ?>" required autocomplete="off">
					</p>
					<p>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="email" name="email" type="email" placeholder="Enter Your Email Id" value="<?php getInputValue('email') ?>" required>
					</p>

					<p>
						<label for="email2">Confirm email</label>
						<input id="email2" name="email2" type="email" placeholder="Confirm Your Email Id" value="<?php getInputValue('email2') ?>" required>
					</p>
			...
			<div id="loginText">
				...
				<ul>
					<li>Access To Ultimate Music Of All Kind Of Genre.</li>
